...
class VipleLaunchPadV4:
    ...
    def create_widget(self):
        ...
        default_bg_color = '#1B4F72'  # Bleu Viple par défaut
    ...
    def create_widget_content(self):
        # Couleur de fond transparente pour les widgets
        transparent_bg = None  # Utilise la couleur du parent
        widget_bg_color = '#1B4F72'  # Couleur de secours
        ...
        if self.bg_photo:
            ...
            # Frame principale avec fond semi-transparent
            main_frame = tk.Frame(self.root, bd=0)
            main_frame.configure(bg=widget_bg_color)  # Couleur de base
        else:
            main_frame = tk.Frame(self.root, bg=widget_bg_color, bd=0)
        
        main_frame.place(x=0, y=0, width=280, height=160)
        
        # Si on a une image de fond, rendre la frame semi-transparente visuellement
        if self.bg_photo:
            # On utilise la même couleur mais on compte sur la transparence de la fenêtre
            main_frame.configure(bg=widget_bg_color)
        ...
        header_frame = tk.Frame(main_frame, bg=widget_bg_color, bd=0)
        ...
        # Titre avec couleur de fond appropriée
        ...
        button_frame = tk.Frame(main_frame, bg=widget_bg_color, bd=0)
        button_frame.pack(expand=True, fill='both', padx=20)
        
        # Style des boutons avec couleurs spécifiques
        button_style = {
            'font': ("Arial", 9, "bold"),
            'fg': 'white',
            'relief': 'flat',
        ...
        # Bouton Lancer le Manager - Violet
        ...
        # Si on a une image de fond, ajuster la transparence des éléments
        if self.bg_photo:
            self.adjust_transparency_for_background()
    
    def adjust_transparency_for_background(self):
        """Ajuste les couleurs pour améliorer la visibilité avec l'image de fond"""
        # Cette fonction peut être étendue pour ajuster dynamiquement les couleurs
        pass
    ...
    def create_system_tray(self):
        ...
        try:
            ...
            print("✓ Icône Viple V4 ajoutée à la barre système (version corrigée)")
